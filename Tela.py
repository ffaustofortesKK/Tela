...
# FORÇAR EXTENSÃO MP4 PARA GARANTIR COMPATIBILIDADE TOTAL COM O PLAYER
...
# 2. TELA PRINCIPAL: FILA DE ESPERA À ESQUERDA E PLAYER NATIVO À DIREITA
else:
    ...
    with cl2:
        ...
        if url_video:
            ...
            # Utilização do player nativo do Streamlit que acabou de provar funcionar perfeitamente
